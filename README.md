...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=22&pause=1000&color=6366F1&center=true&vCenter=true&random=false&width=600&lines=Building+Modern+Web+Experiences;Automating+Business+Workflows+with+AI;Turning+Ideas+into+Production+Systems" alt="Typing SVG" />
</p>
...
Frontend developer and AI automation specialist with hands-on experience building production-ready applications and intelligent workflow systems.

- **Frontend**: 2+ internships building enterprise dashboards with React, TailwindCSS, and MUI
- **AI Automation**: Deployed systems processing **200+ leads/day** using n8n, Zapier, and Make.com
- **Impact**: Reduced operational effort by **30%+** through automation solutions
- **DSA**: 150+ LeetCode problems solved in Python
...
> 
> AI-powered B2B lead processing system handling **200+ leads daily** with automated validation and enrichment.
> 
> `n8n` `OpenAI` `REST APIs` `Google Sheets`
> 
> [![View Code](https://img.shields.io/badge/View_Code-6366F1?style=flat-square&logo=github&logoColor=white)](https://github.com/pprathik07)
...
> 
> Smart media tracking with auto-metadata extraction and dashboard sync.
> 
> `Zapier` `AI` `Looker Studio`
> 
> [![View Code](https://img.shields.io/badge/View_Code-6366F1?style=flat-square&logo=github&logoColor=white)](https://github.com/pprathik07/media-automation/)

---

### LeetCode

![LeetCode](https://img.shields.io/badge/150+_Problems_Solved-FFA116?style=for-the-badge&logo=leetcode&logoColor=white)

**Focus**: Arrays · Strings · Stacks · Trees · Graphs · Sliding Window
